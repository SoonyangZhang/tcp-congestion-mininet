...
class QUIC_EXPORT_PRIVATE QuicMemSliceImpl {
 public:
  ...
  QuicMemSliceImpl(base::scoped_refptr<net::IOBuffer> io_buffer, size_t length);
  ...
  base::scoped_refptr<net::IOBuffer>* impl() { return &io_buffer_; }

  size_t* impl_length() { return &length_; }

 private:
  base::scoped_refptr<net::IOBuffer> io_buffer_;
