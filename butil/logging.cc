...
bool FLAGS_crash_on_fatal_log=false;
bool FLAGS_print_stack_on_check=false;
int FLAGS_v=0;
std::string FLAGS_vmodule("per-module verbose level");
bool FLAGS_log_process_id=false;
int FLAGS_minloglevel=0;
bool FLAGS_log_hostname=false;
bool FLAGS_log_year=false;
namespace {
