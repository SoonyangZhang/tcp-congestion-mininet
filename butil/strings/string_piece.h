...
using StringPieceHash = StringPieceHashImpl<butil::StringPiece>;
using StringPiece16Hash = StringPieceHashImpl<butil::StringPiece16>;
//using WStringPieceHash = StringPieceHashImpl<butil::WStringPiece>;
}  // namespace butil
